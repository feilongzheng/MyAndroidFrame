...
public class FileRequestAgent {
    ...
    public static void sendPostRequest(Map<String, File> FileParams, Map<String, String> stringParams, String urlPlus, Class resultClzz, Context loadingDialogContext, final ResponseListener responseListener) {
        sendRequest(true, FileParams, stringParams, urlPlus, resultClzz, loadingDialogContext, responseListener);
    }

    public static void sendPostRequest(boolean isDecodeResponse, Map<String, File> fileParams, Map<String, String> stringParams, String urlPlus, Class resultClzz, Context loadingDialogContext, final ResponseListener responseListener) {
        sendRequest(isDecodeResponse, fileParams, stringParams, urlPlus, resultClzz, loadingDialogContext, responseListener);
    }

    private static void sendRequest(boolean isDecodeResponse, Map<String, File> fileParams, Map<String, String> stringParams, String urlPlus, Class resultClzz, final Context loadingDialogContext, final ResponseListener responseListener) {
        ...
        if(!Utility.isListNull(stringParams)){
