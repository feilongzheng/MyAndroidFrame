...
public class FlatButton extends Button {
	...
	private LayerDrawable createNormalDrawable(TypedArray attr) {
		LayerDrawable drawableNormal = (LayerDrawable) getDrawable(R.drawable.progress_button_rect_normal).mutate();
	...
	private Drawable createPressedDrawable(TypedArray attr) {
		GradientDrawable drawablePressed = (GradientDrawable) getDrawable(R.drawable.progress_button_rect_pressed).mutate();
