package com.lcworld.fitness.framework.widget.processbutton;
...
public abstract class ProcessButton extends FlatButton {
	...
	private void init(Context context, AttributeSet attrs) {
		...
		mProgressDrawable = (GradientDrawable) getDrawable(R.drawable.progress_button_rect_progress).mutate();
		mProgressDrawable.setCornerRadius(getCornerRadius());

		mCompleteDrawable = (GradientDrawable) getDrawable(R.drawable.progress_button_rect_complete).mutate();
		mCompleteDrawable.setCornerRadius(getCornerRadius());

		mErrorDrawable = (GradientDrawable) getDrawable(R.drawable.progress_button_rect_error).mutate();
